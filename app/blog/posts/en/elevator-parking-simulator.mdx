...
Research directions (future code): arrival-probability parking, MDP lobby-car counts for up-peak, proactive standby scores, and **service zoning** when saturated.
