...
const experienceKo: ExperienceItem[] = [
  {
    ...
    highlights: [
      ...
      '거래내역·사이즈 프리미엄·시즌성을 추적해 데이터 기반 매입·판매 기준 설정',
  ...
  },
  {
    ...
    highlights: [
      '회수 차량 재고·정비 데이터 정확도와 100% 운용 가능 상태 유지',
      '엑셀 사용 로그로 부품·장비 재고를 모니터링하고 적시 보급',
      '긴박한 상황에서 견인·회수 운용, 안전 수칙 준수로 무사고 유지',
    ],
  },
  {
    id: 'kj-technology',
  ...
  },
  {
    ...
    highlights: [
      '기사 14명의 운행 경로 데이터로 배송망 비효율 구간 파악',
      '경로 재배치·타임슬롯 조정으로 총 배송 시간 23% 단축',
      '일 2,500식 물류 스케줄과 정시 배송 모니터링',
    ],
  },
]
