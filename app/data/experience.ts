...
const experienceKo: ExperienceItem[] = [
  {
    ...
    location: 'Canada / South Korea',
    summary:
      '스니커즈 리셀을 운영하며 SKU 단위 재고·가격 관리와 시장 추적으로 매입·판매 의사결정을 했습니다.',
    highlights: [
      '리스팅 SKU의 재고·가격을 관리해 마진을 지키고 재고 회전을 높임',
      '거래내역·사이즈 프리미엄·시즌성을 추적해 데이터 기반 매입·판매 기준을 설정',
      'Python·Power BI로 리셀 프리미엄, 거래량, sell-through를 모니터링하는 워크플로를 구축',
    ],
  },
  {
    id: 'rok-army',
    ...
    location: 'South Korea',
    summary:
      '중장비 회수 차량의 재고·정비 데이터를 관리하고, 운용 가능 상태를 유지했습니다.',
    highlights: [
      '회수 차량 재고·정비 데이터 정확도와 100% 운용 가능 상태를 유지',
      '엑셀 사용 로그로 부품·장비 재고를 모니터링하고 적시에 보급',
      '긴급 상황에서 견인·회수 운용을 수행하고, 안전 수칙 준수로 무사고를 유지',
    ],
  },
  {
    id: 'kj-technology',
    ...
    highlights: [
      '기술 문서 정리와 운영 절차 표준화로 인증 심사를 준비',
      '생산팀과 함께 프로세스 준수·기록 품질을 검증',
      '품질경영 체계 구축을 지원하고 인증 취득에 기여',
    ],
  },
  {
    id: 'within-company',
    ...
    highlights: [
      '배송 기사 14명의 운행 경로 데이터로 배송망 비효율 구간을 파악',
      '경로 재배치·타임슬롯 조정으로 총 배송 시간을 23% 단축',
      '일 2,500식 물류 스케줄과 정시 배송을 모니터링',
    ],
  },
]
